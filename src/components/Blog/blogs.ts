...
As my interest deepened, I became more involved in tech communities and learning opportunities. I attended a bootcamp through Global Code alongside a few peers, and for the first time, technology began to feel practical and collaborative rather than distant or intimidating. Later, attending PyCon Africa became another defining experience. Participating in the Django Girls session and building a Django-powered website showed me how much progress was possible within a relatively short period of time. That same website would later become the foundation for my personal portfolio.
